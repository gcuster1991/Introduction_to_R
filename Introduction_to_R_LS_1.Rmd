...
#Final exercise
Using what you have seen above, create a histogram of the column called pH from the metadata. Change the title to "pH of all sites", the X-axis to "pH", and the Y-axis to "number of sites". Include the code you used in your handout under the final exercise heading. 
