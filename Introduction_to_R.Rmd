...
As an example, lets use the file named "pima.csv". We have already loaded this to your folder on the desktop. 
...
str(subset_Pima)
```
Exercise 10: Can you interpret what is going on in the line () of code? Try to put it into plain English. Hint %in% reads as "found in". 
