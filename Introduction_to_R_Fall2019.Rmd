...
Exercise 4: Insert a new chunk below. Then, write the correct code to change the working directory to your folder on the Desktop of your computer that your created at the beginning of lab, and write the code to get your current directory. Run your code and copy the code you created to the exercise 3 location in your lab handout. 
...
```{r}
#Code 1
setwd("insert correct pathway to your folder here")
read.csv("Pima.csv")
```
Code 2 
```{r}
...
Pima <- read.csv(Pima.csv)
```
Hint: Instead of "/Desktop/Introduction...." you will type "/Downloads/" in your path. 
```{r}
setwd("insert correct pathway to your Downloads folder here")
Pima <- read.csv("Pima.csv")
```
...
Exercise 13: Insert a new chunk of code (don't remember how do do this, see line 81) and write a code that will pull only the first two rows of the columns "age" and "triceps" and call the resulting data frame "subset_Pima_3. Copy your final code to your lab handout in the exercise 11 location.
